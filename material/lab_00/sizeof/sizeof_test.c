...
void print_size(char str_array[])
{
	...
	char *str_ptr =
		"my nice, quite long string (for sure more than 8 bytes...)";
	...
	printf("sizeof(int_var) = %ld, sizeof(int) = %ld\n"
	       ...
	       "sizeof(str_array) = %ld\nsizeof(str_out) = %ld\n",
	       sizeof(int_var), sizeof(uint32_t), sizeof(float_var),
	       sizeof(float), sizeof(double_var), sizeof(double),
	       sizeof(char_var), sizeof(unsigned char), sizeof(str_ptr),
	       sizeof(char *), sizeof((char *)str_array), sizeof(str_out));
